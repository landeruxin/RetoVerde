...
public class VerEventos extends AppCompatActivity implements AdapterView.OnItemLongClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                Toast.makeText(getApplication(), "No hay ningún evento este día.",Toast.LENGTH_SHORT).show();
                this.finish();
            }
